 ...
 if (messenger != 0) {
   ...
   $.ajax({
     ...
     success: (data) => {
       ...
       $(".chat_rental_container .total_order").html(data.total_order);
       $(".chat_rental_container .item_list").html(data.order_history);
       // Star status
       data.favorite > 0
...
if($(window).innerWidth() < 980) {
   $(document).on('click',"#message-form textarea[name='message']" ,function() {
