...
@section('title', 'Create Highlight Tag')
@section('breadcrumb', 'Highlight Tag')
@section('breadcrumb-info', 'Create Highlight Tag')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/highlight-tag') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('admin.highlight-tag.form', ['formMode' => 'create'])
                </form>
            </div>
        </div>
    </div>
