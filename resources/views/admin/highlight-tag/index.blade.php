...
@section('title', 'Highlight Tag')
@section('breadcrumb', 'Highlight Tag')
@section('breadcrumb-info', 'Highlight Tag Lists')
@push('style')
@endpush
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/highlight-tag/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="highlightTagTable">
                        <thead>
                        ...
                        <tbody class="fw-bold text-gray-600" id="highlight-tag">
...
<script>
    $(document).ready(function() {
        let me = this;
        me.table = $("#highlightTagTable").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/highlight-tag/getData",
                type: 'POST',
                headers: {
