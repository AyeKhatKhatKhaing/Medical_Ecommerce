<div class="row">
    <div class="row mb-5">
        <div class="col-md-8">
            <h3 class="card-title">
                @if($formMode == "edit") Edit Highlight Tag @else Add New Highlight Tag @endif
            </h3>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <div class="float-end">
                    ...
                    <a href="{{ url('admin/highlight-tag') }}" title="Back"><button type="button" class="btn btn-secondary btn-sm cancel"><i class="bi bi-x" aria-hidden="true"></i> Cancel</button></a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="tab-pane fade {{ $attr == 'en' ? 'active show' : '' }}"  id="{{ strtolower($lngcode) }}-tab">
                                ...
                                @if($attr == 'tc')
                                    <div class="form-check mb-5 mt-5 d-flex align-items-center">
                                        <input class="form-check-input" type="checkbox" {{isset($highlight_tag->is_translate)&&$highlight_tag->is_translate==1?'checked':''}} name="is_translate" id="auto_translate" value="1">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="panel-block">
                    <div class="form-group">
                        <div id="holder-img">
                            @if(!empty($highlight_tag->img))
                                <div class='lfmimage-container imglfmc0'>
                                    <img src="{{ asset($highlight_tag->img) }}" class='lfmimage w-100' style="height: 20rem;">
                                    <div>
                        ...
                        <div class="input-group mt-3">
                            ...
                            <input id="img" class="form-control" type="text" name="img" value="{{isset($highlight_tag) ? $highlight_tag->img : ''}}">
                        </div>
                    </div>
                </div>
            </div>
