<div class="row">
    <div class="row mb-5">
        <div class="col-md-8">
            <h3 class="card-title">
            @if($formMode == "edit") Edit Dose Tag @else Add New Dose Tag @endif
            </h3>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <div class="float-end">
                    ...
                    <a href="{{ url('admin/dose-tag') }}" title="Back"><button type="button" class="btn btn-secondary btn-sm cancel"><i class="bi bi-x" aria-hidden="true"></i> Cancel</button></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade {{ $attr == 'en' ? 'active show' : '' }}"  id="{{ strtolower($lngcode) }}-tab">
                            <div class="form-group mb-5{{ $errors->has('name_'.$attr) ? 'has-error' : ''}}">
                                {!! Form::label('name_'.$attr, 'Name' . ' (' . $lngcode . ')', ['class' => 'control-label required mb-3']) !!}
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="panel-block">
                    <div class="form-group">
                       <div id="holder-img">
                            @if(!empty($dosetag->img))
                                <div class='lfmimage-container imglfmc0'>
                                    <img src="{{ asset($dosetag->img) }}" class='lfmimage w-100' style="height: 20rem;">
                                    <div>
                       ...
                       <div class="input-group mt-3">
                            ...
                            <input id="img" class="form-control" type="text" name="img" value="{{isset($dosetag) ? $dosetag->img : ''}}">
                       </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between nopadding">
                    ...
                    <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_published" id="is_published" @if(isset($dosetag) && $dosetag->is_published == '1') checked @endif>
                    </div>
                </div>
            </div>
        </div>
