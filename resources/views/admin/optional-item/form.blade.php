<div class="row">
    <div class="row mb-5">
        <div class="col-md-8">
            <h3 class="card-title">
            @if($formMode == "edit") Edit Optional Item @else Add New Optional Item @endif
            </h3>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <div class="float-end">
                    ...
                    <a href="{{ url('/admin/optional-item') }}" title="Back"><button type="button" class="btn btn-secondary btn-sm cancel"><i class="bi bi-x" aria-hidden="true"></i> Cancel</button></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="card-body content-body">
                    <div class="tab-content">
                        <div class="form-group mb-5{{ $errors->has('optional_id') ? 'has-error' : ''}}">
                            {!! Form::label('optional_id', 'Main Optional Item', ['class' => 'form-label mb-3']) !!}
                            {!! Form::select('optional_id', $main_optional, null , ['class' => 'form-select form-select-solid', 'data-control' => 'select2', 'data-hide-search' => "true", 'data-placeholder' => "Select Main Optional Item", 'placeholder' => "Select Main Optional Item", "data-kt-ecommerce-product-filter" => "optional_id"]) !!}
                            {!! $errors->first('optional_id', '<p class="help-block text-danger">:message</p>') !!}
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="panel-block">
                    <div class="form-group">
                       <div id="holder-img">
                            @if(!empty($optionalitem->img))
                                <div class='lfmimage-container imglfmc0'>
                                    <img src="{{ asset($optionalitem->img) }}" class='lfmimage w-100' style="height: 20rem;">
                                    <div>
                       ...
                       <div class="input-group mt-3">
                            ...
                            <input id="img" class="form-control" type="text" name="img" value="{{isset($optionalitem) ? $optionalitem->img : ''}}">
                       </div>
                    </div>
                </div>
            </div>
