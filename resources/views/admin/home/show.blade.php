                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Banner Title En </th><td> {{ $home->banner_title_en }} </td></tr><tr><th> Banner Title Tc </th><td> {{ $home->banner_title_tc }} </td></tr><tr><th> Banner Title Sc </th><td> {{ $home->banner_title_sc }} </td></tr>
                                </tbody>
                            </table>
                        </div>
