...
@section('title', 'ChooseMediq')
@section('breadcrumb', 'ChooseMediq')
@section('breadcrumb-info', 'ChooseMediq Lists')
@push('style')
@endpush
@section('content')
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-3">
                    <a href="{{ url('/admin/choose-mediq/create') }}" class="btn btn-primary btn-sm pull-right" title="Add New Tag">
