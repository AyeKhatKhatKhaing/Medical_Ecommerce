...
@section('title', 'CheckUpType')
@section('breadcrumb', 'CheckUpType')
@section('breadcrumb-info', 'CheckUpType Lists')
@push('style')
@endpush
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    {{-- <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/check-up-type/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>
                    </div> --}}
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="checkUpTypeTable">
                        <thead>
                        ...
                        <tbody class="fw-bold text-gray-600" id="check-up-type-table">
                        </tbody>
                    </table>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        let me = this;
        me.table = $("#checkUpTypeTable").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/check-up-type/getData",
                type: 'POST',
                headers: {
                ...
                data: function(f) {
                    ...
                    f.checkupgroup = $('select[name=check_up_group]').val();
                    f.search = $('#search').val();
                }
            },
            columns: [{
        ...
        // $('#check_up_group').on('change', function(e) {
        //     me.table.draw();
        //     e.preventDefault();
        // });
    });
