                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Banner Photo </th><td> {{ $about->banner_photo }} </td></tr><tr><th> Banner Title En </th><td> {{ $about->banner_title_en }} </td></tr><tr><th> Banner Description En </th><td> {{ $about->banner_description_en }} </td></tr>
                                </tbody>
                            </table>
                        </div>
