        ...
        <div class="col-md-4">
            <div class="form-group">
                <div class="float-end">
                    ...
                    <a href="{{ url('admin/pages') }}" title="Back"><button type="button" class="btn btn-secondary btn-sm cancel"><i class="bi bi-x" aria-hidden="true"></i> Cancel</button></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="card mt-2">
            <div class="card-header">
                <p class="card-title fs-6">Background Image</p>
            </div>
            <div class="card-body">
                <div class="list-title mb-3">
                    <label for="kt_ecommerce_add_product_store_template" class="form-label">
                ...
                <div class="panel-block">
                    <div class="form-group">
                        <div id="holder-bg_img">
                            @if(!empty($page->bg_img))
                                <div class='lfmimage-container imglfmc0'>
                                    <img src="{{ asset($page->bg_img) }}" class='lfmimage w-100' style="height: 20rem;">
                                    <div>
                                        <button type="button" onclick="removeImage('bg_img',0)" class='btn btn-sm btn-danger w-100'>Remove</button>
                                    </div>
                                </div>
                            @else
                                <img src="{{ asset('backend/media/blank-image.svg') }}" class="img-thumbnail">
                        ...
                        <div class="input-group mt-3">
                            <span class="input-group-btn">
                                <a data-input="bg_img" data-preview="holder-bg_img" class="btn btn-primary text-white lfm-img">
                                    <i class="bi bi-image-fill me-2"></i>Select File
                                </a>
                            </span>
                            <input id="bg_img" class="form-control" type="text" name="bg_img" value="{{isset($page) ? $page->bg_img : ''}}">
                        </div>
                    </div>
                </div>
            </div>
