...
@section('title', 'SaleCategory')
@section('breadcrumb', 'SaleCategory')
@section('breadcrumb-info', 'SaleCategory Lists')
@push('style')
@endpush
@section('content')
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/sale-category/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>                           
                    </div>
                </div>
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="doseTagTable">
                        ...
                        <tbody class="fw-bold text-gray-600" id="sale-category">
...
<script>
    $(document).ready(function() {
        ...
        me.table = $("#doseTagTable").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "/admin/sale-category/getData",
                type: 'POST',
                headers: {
