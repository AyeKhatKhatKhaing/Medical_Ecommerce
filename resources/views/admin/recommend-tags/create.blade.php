...
@section('title', 'Create RecommendTag')
@section('breadcrumb', 'RecommendTag')
@section('breadcrumb-info', 'Create RecommendTag')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            ...
            @endif
                ...
                <form method="POST" action="{{ url('/admin/recommend-tags') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('admin.recommend-tags.form', ['formMode' => 'create'])
