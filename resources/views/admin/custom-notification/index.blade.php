...
@section('breadcrumb-info', 'Custom Notification Lists')
@push('style')
@endpush
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title filter-style">
                        ...
                        <div class="filter-section">
                            <label for="" style="font-size: 14px">Enable Selection Status</label>
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/customnotification/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="customNotificationTable">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                <th>ID</th>
                                <th>Title</th>
                                <th>Description</th>
                                <th>Enable Selection</th>
                                <th>Created At</th>
                                <th>Updated At</th>
...
<script>
    $(document).ready(function() {
        let me = this;
        me.table = $("#customNotificationTable").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/customnotification/getData",
                type: 'POST',
                headers: {
