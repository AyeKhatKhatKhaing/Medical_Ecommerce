...
@section('title', 'Create AddOnItem')
@section('breadcrumb', 'AddOnItem')
@section('breadcrumb-info', 'Create AddOnItem')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/add-on-item') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('admin.add-on-item.form', ['formMode' => 'create'])
