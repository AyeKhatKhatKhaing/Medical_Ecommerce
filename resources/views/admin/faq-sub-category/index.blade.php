                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/faq-sub-category/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        me.table = $("#categoryTable").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "/admin/faq-sub-category/getData",
                type: 'POST',
                headers: {
