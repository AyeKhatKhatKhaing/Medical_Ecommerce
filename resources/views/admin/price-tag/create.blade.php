...
@section('title', 'Create Price Tag')
@section('breadcrumb', 'Price Tag')
@section('breadcrumb-info', 'Create Price Tag')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/price-tag') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('admin.price-tag.form', ['formMode' => 'create'])
                </form>
            </div>
        </div>
    </div>
