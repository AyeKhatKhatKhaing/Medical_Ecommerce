                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Help1 Icon </th><td> {{ $contact->help1_icon }} </td></tr><tr><th> Help1 Name En </th><td> {{ $contact->help1_name_en }} </td></tr><tr><th> Help1 Name Tc </th><td> {{ $contact->help1_name_tc }} </td></tr>
                                </tbody>
                            </table>
                        </div>
