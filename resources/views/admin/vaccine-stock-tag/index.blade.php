...
@section('title', 'Vaccine Stock')
@section('breadcrumb', 'Vaccine Stock')
@section('breadcrumb-info', 'Vaccine Stock Lists')
@push('style')
@endpush
@section('content')
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <h1>Vaccine Stock Tag</h1>
                    </div>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/vaccine-stock-tag/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>                           
                    </div>
                </div>
                <div class="card-header border-0 pt-6">
                ...
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="vaccineStockTagTable">
                        <thead>
                        ...
                        <tbody class="fw-bold text-gray-600" id="vaccine-factory-tag">
...
<script>
    $(document).ready(function() {
        let me   = this;
        me.table = $("#vaccineStockTagTable").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/vaccine-stock-tag/getData",
                type: 'POST',
                headers: {
