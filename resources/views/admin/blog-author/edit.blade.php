...
@section('breadcrumb', 'Blog Author')
@section('breadcrumb-info', 'Edit Blog Author')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                {!! Form::model($blogAuthor, [
                    'method' => 'PATCH',
                    'url' => ['/admin/blog-author', $blogAuthor->id],
                    'class' => 'form-horizontal'
                    ]) !!}

                    @include ('admin.blog-author.form', ['formMode' => 'edit'])
