<div class="row">
    <div class="row mb-5">
        <div class="col-md-8">
            <h3 class="card-title">
            @if($formMode == "edit") Edit Blog Author @else Add New Blog Author @endif
            </h3>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <div class="float-end">
                    ...
                    <a href="{{ url('admin/blog-author') }}" title="Back"><button type="button" class="btn btn-secondary btn-sm cancel"><i class="bi bi-x" aria-hidden="true"></i> Cancel</button></a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body content-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade {{ $attr == 'en' ? 'active show' : '' }}"  id="{{ strtolower($lngcode) }}-tab">
                            ...
                            <div class="form-group mb-5{{ $errors->has('position_'.$attr) ? 'has-error' : ''}}">
                                {!! Form::label('position_'.$attr, 'Position' . ' (' . $lngcode . ')', ['class' => 'form-label required']) !!}
                                {!! Form::text('position_'.$attr, null, ('required' == 'required') ? ['class' => 'form-control'] : ['class' => 'form-control']) !!}
                                {!! $errors->first('position_' . $attr, '<p class="help-block text-danger">:message</p>') !!}
                            </div>
                                            ...
                                            <div class="panel-block">
                                                <div class="form-group">
                                                   <div id="holder-meta-image">
                                                        @if(!empty($blogAuthor->meta_image))
                                                            <div class='lfmimage-container meta-imagelfmc0'>
                                                                <img src="{{ asset($blogAuthor->meta_image) }}" class='lfmimage w-100' style="height: 20rem;">
                                                                <div>
                                                   ...
                                                   <div class="input-group mt-3">
                                                        ...
                                                        <input id="meta-image" class="form-control" type="text" name="meta_image" value="{{isset($blogAuthor) ? $blogAuthor->meta_image : ''}}">
                                                   </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            @if($attr == 'tc')
                                <div class="form-check mb-5 mt-5 d-flex align-items-center">
                                    <input class="form-check-input" type="checkbox" {{isset($blogAuthor->is_translate)&&$blogAuthor->is_translate==1?'checked':''}} name="is_translate" id="auto_translate" value="1">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-6 col-md-6">
                                <div class="form-group mb-5{{ $errors->has('fb_link') ? 'has-error' : ''}}">
                                    {!! Form::label('fb_link', 'FB Link', ['class' => 'form-label']) !!}
                                    {!! Form::text('fb_link', null, ('required' == 'required') ? ['class' => 'form-control'] : ['class' => 'form-control']) !!}
                                    {!! $errors->first('fb_link' . $attr, '<p class="help-block text-danger">:message</p>') !!}
                                </div>
                                <div class="form-group mb-5{{ $errors->has('twitter_link') ? 'has-error' : ''}}">
                                    {!! Form::label('twitter_link', 'Twitter Link', ['class' => 'form-label']) !!}
                                    {!! Form::text('twitter_link', null, ('required' == 'required') ? ['class' => 'form-control'] : ['class' => 'form-control']) !!}
                                    {!! $errors->first('twitter_link' . $attr, '<p class="help-block text-danger">:message</p>') !!}
                                </div>
                                <div class="form-group mb-5{{ $errors->has('linkedin_link') ? 'has-error' : ''}}">
                                    {!! Form::label('linkedin_link', 'Linkedin Link', ['class' => 'form-label']) !!}
                                    {!! Form::text('linkedin_link', null, ('required' == 'required') ? ['class' => 'form-control'] : ['class' => 'form-control']) !!}
                                    {!! $errors->first('linkedin_link' . $attr, '<p class="help-block text-danger">:message</p>') !!}
                                </div>
                            </div>
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="panel-block">
                    <div class="form-group">
                       <div id="holder-img">
                            @if(!empty($blogAuthor->profile_img))
                                <div class='lfmimage-container imglfmc0'>
                                    <img src="{{ asset($blogAuthor->profile_img) }}" class='lfmimage w-100' style="height: 20rem;">
                                    <div>
                       ...
                       <div class="input-group mt-3">
                            ...
                            <input id="img" class="form-control" type="text" name="profile_img" value="{{isset($blogAuthor) ? $blogAuthor->profile_img : ''}}">
                       </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between nopadding">
                    ...
                    <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_published" id="is_published" value="1" @if(isset($blogAuthor)) @if($blogAuthor->is_published == '1')checked @endif @else checked @endif>
                    </div>
                </div>
            </div>
        </div>
