...
@section('title', 'Create BlogAuthor')
@section('breadcrumb', 'BlogAuthor')
@section('breadcrumb-info', 'Create BlogAuthor')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/blog-author') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('admin.blog-author.form', ['formMode' => 'create'])
                </form>
            </div>
        </div>
    </div>
