...
@section('title', 'Create Feature Tag')
@section('breadcrumb', 'Feature Tag')
@section('breadcrumb-info', 'Create Feature Tag')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/feature-tag') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('admin.feature-tag.form', ['formMode' => 'create'])
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).on('change','#auto_translate',function() {
            ...
            if (val==1){
                ...
                $.ajax({
                    url: "{{ url('/admin/feature-tag-auto-translate') }}",
