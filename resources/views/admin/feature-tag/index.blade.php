...
@section('breadcrumb', 'Feature Tag')
@section('breadcrumb-info', 'Feature Tag Lists')
@push('style')
@endpush
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/feature-tag/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="featureTagTable">
                        <thead>
                        ...
                        <tbody class="fw-bold text-gray-600" id="feature-tag">
...
<script>
    $(document).ready(function() {
        let me = this;
        me.table = $("#featureTagTable").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/feature-tag/getData",
                type: 'POST',
                headers: {
