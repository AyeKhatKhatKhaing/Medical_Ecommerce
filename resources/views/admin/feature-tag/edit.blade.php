...
@section('title', 'Edit Feature Tag')
@section('breadcrumb', 'Feature Tag')
@section('breadcrumb-info', 'Edit Feature Tag')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                {!! Form::model($feature_tag, [
                    'method' => 'PATCH',
                    'url' => ['/admin/feature-tag', $feature_tag->id],
                    'class' => 'form-horizontal'
                    ]) !!}

                @include ('admin.feature-tag.form', ['formMode' => 'edit'])
