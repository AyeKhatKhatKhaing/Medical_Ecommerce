...
@section('title', 'Promotion Campaign')
@section('breadcrumb', 'Promotion Campaign')
@section('breadcrumb-info', 'Promotion Campaign Lists')
@push('style')
@endpush
@section('content')
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <h1>Promotion Campaign</h1>
                    </div>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/promotion-campaign/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>                           
                    </div>
                </div>
                <div class="card-header border-0 pt-6">
...
<script>
    $(document).ready(function() {
        ...
        me.table = $("#doseTagTable").DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "/admin/promotion-campaign/getData",
                type: 'POST',
                headers: {
