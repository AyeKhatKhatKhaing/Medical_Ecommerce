...
@section('title', 'Create BlogCategory')
@section('breadcrumb', 'BlogCategory')
@section('breadcrumb-info', 'Create BlogCategory')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/blog-category') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
