            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open([
                            'method'=>'DELETE',
                            'url' => ['admin/faqcategory', $faqcategory->id],
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name En </th><td> {{ $faqcategory->name_en }} </td></tr><tr><th> Name Sc </th><td> {{ $faqcategory->name_sc }} </td></tr><tr><th> Name Tc </th><td> {{ $faqcategory->name_tc }} </td></tr>
                                </tbody>
                            </table>
                        </div>
