...
@section('title', 'Check Up Table')
@section('breadcrumb', 'Check Up Table')
@section('breadcrumb-info', 'Check Up Table Lists')
@push('style')
@endpush
@section('content')
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/check-up-table/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="checkUpTable">
                        ...
                        <tbody class="fw-bold text-gray-600" id="check-up-table">
...
<script>
    $(document).ready(function() {
        let me = this;
        me.table = $("#checkUpTable").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/check-up-table/getData",
                type: 'POST',
                headers: {
