...
@section('title', 'PaymentType')
@section('breadcrumb', 'PaymentType')
@section('breadcrumb-info', 'Payment Type Lists')
@push('style')
@endpush
@section('content')
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="paymentTypeTable">
                            <thead>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            let me = this;
            me.table = $("#paymentTypeTable").DataTable({
                searchDelay: 500,
                processing: true,
                serverSide: true,
                ajax: {
                    url: "/admin/payment-type/getData",
                    type: 'POST',
                    headers: {
