        ...
        <div class="card mt-4">
            <div class="card-body">
                <div class="d-flex justify-content-between nopadding">
                    <label for="" style="font-size: 13px;">Featured Home Page?</label>
                    <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_home" id="is_home" @if(isset($subcategory) && $subcategory->is_home == '1') checked @endif>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel-block">
                    <div class="form-group">
                       <div id="holder-img">
                            @if(!empty($subcategory->img))
                                <div class='lfmimage-container imglfmc0'>
                                    <img src="{{ asset($subcategory->img) }}" class='lfmimage w-100' style="height: 20rem;">
                                    <div>
                       ...
                       <div class="input-group mt-3">
                            ...
                            <input id="img" class="form-control" type="text" name="img" value="{{isset($subcategory) ? $subcategory->img : ''}}">
                       </div>
                    </div>
                </div>
            </div>
