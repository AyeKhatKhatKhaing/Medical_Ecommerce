...
@section('title', 'Create Dashboard sliders')
@section('breadcrumb', 'Dashboard sliders')
@section('breadcrumb-info', 'Create Dashboard sliders')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/dashboard-sliders') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('admin.dashboard-slider.form', ['formMode' => 'create'])
    ...
    <script>
        ...
        $(document).on('change','#auto_translate',function() {
            ...
            if (val==1){
                ...
                $.ajax({
                    url: "{{ url('/admin/dashboard-slider-auto-translate') }}",
