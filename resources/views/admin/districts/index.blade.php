...
@section('breadcrumb', 'District')
@section('breadcrumb-info', 'District Lists')
@push('style')
@endpush
@section('content')
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    <div class="card-title filter-style">
                        ...
                        <div class="filter-section">
                            <label for="" style="font-size: 14px">Territory</label>
                            <div class="card-toolbar mx-4">
                                <div class="d-flex justify-content-center" data-kt-customer-table-toolbar="base">
                                    <div class="w-150px me-3">
                                        <select class="form-select form-select-solid" name="territory" id="territory" data-control="select2" data-hide-search="true" data-placeholder="Territory" data-kt-ecommerce-order-filter="territory">
                                            <option></option>
                                            <option value="all">All</option>
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/districts/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="districts_table">
                        <thead>
...
<script>
    $(document).ready(function() {
        let me = this;
        me.table = $("#districts_table").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/districts/getData",
                type: 'POST',
                headers: {
                ...
                data: function(f) {
                    ...
                    f.search = $('#search').val();
                    f.territory = $('select[name=territory]').val();
                }
            },
            columns: [{
                    data: 'id',
