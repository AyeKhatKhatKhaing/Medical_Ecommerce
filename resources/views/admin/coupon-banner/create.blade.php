...
@section('title', 'Create Coupon Banner')
@section('breadcrumb', 'Coupon Banner')
@section('breadcrumb-info', 'Create Coupon Banner')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="POST" action="{{ url('/admin/coupon-banner') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('admin.coupon-banner.form', ['formMode' => 'create'])
