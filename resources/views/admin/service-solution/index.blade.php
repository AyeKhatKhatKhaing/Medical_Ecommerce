...
@section('title', 'ServiceSolution')
@section('breadcrumb', 'ServiceSolution')
@section('breadcrumb-info', 'ServiceSolution Lists')
@push('style')
@endpush
@section('content')
            ...
            <div id="kt_content_container" class="container-xxl">
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                <a href="{{ url('/admin/service-solution/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                            </div>                           
                        </div>
                    </div>
                    <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="milestoneYearTable">
                            <thead>
                            ...
                            <tbody class="fw-bold text-gray-600" id="service-solution">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            let me   = this;
            me.table = $("#milestoneYearTable").DataTable({
                searchDelay: 500,
                processing: true,
                serverSide: true,
                ajax: {
                    url: "/admin/service-solution/getData",
                    type: 'POST',
                    headers: {
