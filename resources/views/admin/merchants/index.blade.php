...
@section('breadcrumb-info', 'Merchant Lists')
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="col-md-3 text-end">
                        <a href="{{ route('users.create-user',$user_type) }}" class="btn btn-primary btn-sm pull-right" title="Add New Tag">
