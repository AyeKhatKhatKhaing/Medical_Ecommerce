...
@section('title', 'HomeCheckingItem')
@section('breadcrumb', 'HomeCheckingItem')
@section('breadcrumb-info', 'HomeCheckingItem Lists')
@push('style')
@endpush
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-3">
                    <a href="{{ url('/admin/home-checking-item/create') }}" class="btn btn-primary btn-sm pull-right" title="Add New Tag">
