...
@section('breadcrumb-info', 'Create office information')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
    ...
    @endif -->
                ...
                <form method="POST" action="{{ url('/admin/office-info') }}" accept-charset="UTF-8" class="form-horizontal"
                    enctype="multipart/form-data">
                    {{ csrf_field() }}

                    @include ('admin.office_info.form', ['formMode' => 'create'])
                </form>
            </div>
        </div>
    </div>
