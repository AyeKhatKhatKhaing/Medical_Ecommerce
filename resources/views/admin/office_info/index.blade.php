...
@section('breadcrumb-info', 'Office Information Lists')
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    ...
                    {{-- <div class="col-md-3 text-end">
                        <a href="{{ route('office-info.create') }}" class="btn btn-primary btn-sm pull-right" title="Add New Tag">
                            <i class="bi bi-plus" aria-hidden="true"></i> Add New
                        </a>
                    </div> --}}
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="bank_table">
                        <thead>
                        ...
                        <tbody class="fw-bold text-gray-600" id="users">
...
<script>
    $(document).ready(function() {
        let me = this;
        me.table = $("#bank_table").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/office-info/getData",
                type: 'POST',
                headers: {
