        ...
        <div class="col-md-4">
            <div class="form-group">
                <div class="float-end">
                    ...
                    <a href="{{ url('admin/booking-process') }}" title="Back"><button type="button"
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                                                ...
                                                <div class="panel-block">
                                                    <div class="form-group">
                                                        <div id="holder-meta-image">
                                                            @if (!empty($booking_process_page->meta_img))
                                                                <div class='lfmimage-container meta-imagelfmc0'>
                                                                    <img src="{{ asset($booking_process_page->meta_img) }}"
                                                        ...
                                                        <div class="input-group mt-3">
                                                            ...
                                                            <input id="meta-image" class="form-control" type="text"
                                                                name="meta_img"
                                                                value="{{ isset($booking_process_page) && isset($booking_process_page->meta_img) ? $booking_process_page->meta_img : '' }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="row">
                    @if (isset($booking_process) && $booking_process->count() > 0)
                        @php
                            $maxId = max(array_column($booking_process->toArray(), 'id'));
                        @endphp
                        <input type="text" name="max_id" id="max_id" value="{{ $maxId }}" hidden>
                        @foreach ($booking_process as $key => $booking)
                            <div class="col-md-6">
                                <div class="card mt-4 border new-awesome_booking-input{{ $key }}">
                                    <div class="card-body" style="background-color: #f5f8fa;">
                                        ...
                                        <div class="row">
                                            <input type="text" name="ids_en[]" value="{{ $booking->id }}"
                                                hidden>
                                            <div class="col-md-10">
                                                <div class="card-body pt-0">
                                                    <div class="list-title mb-3">
                                                    ...
                                                    <div class="panel-block">
                                                        <div class="form-group">
                                                            <div id="holder-img-{{ $booking->id }}">
                                                                @if (!empty($booking->img))
                                                                    <div class='lfmimage-container imglfmc0'>
                                                                        <img src="{{ asset($booking->img) }}"
                                                                            class='lfmimage w-100'
                                                                            style="height: 20rem;">
                                                                        <div>
                                                                            <button type="button"
                                                                                onclick="removeImage('img-{{ $booking->id }}',0)"
                                                                                class='btn btn-sm btn-danger w-100'>Remove</button>
                                                                        </div>
                                                                    </div>
                                                                @else
                                                            ...
                                                            <div class="input-group mt-3">
                                                                <span class="input-group-btn">
                                                                    <a id="lfm-img-{{ $booking->id }}"
                                                                        data-input="img-{{ $booking->id }}"
                                                                        data-preview="holder-img-{{ $booking->id }}"
                                                                        class="btn btn-primary btn-sm text-white lfm-img">
                                                                        <i class="bi bi-image-fill me-2"></i>Select
                                                                        File
                                                                    </a>
                                                                </span>
                                                                <input id="img-{{ $booking->id }}"
                                                                    class="form-control" type="text"
                                                                    name="img[]"
                                                                    value="{{ isset($booking) ? $booking->img : '' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
