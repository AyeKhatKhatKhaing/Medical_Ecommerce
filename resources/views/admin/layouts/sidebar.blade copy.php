...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="{{ url('/admin') }}">
            <img alt="Logo" src="{{ asset('backend/media/mediq-logo.svg') }}" class="logo" style="height: 100% !important;" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ isset($page) && $page == 'Dashboard' ? 'active-show' : ''}}" href="{{ url('/admin') }}">
                ...
                <div class="menu-item">
                    <a class="menu-link {{isset($page) && $page == 'customer' ? 'active-show' : ''}} " href="{{url('admin/customer')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ isset($page) && $page == 'filemanager' ? 'active-show' : ''}}" href="{{ url('/admin/filemanager') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Recipient</span>
                    </div>
                </div>

                <div class="menu-item">
                    <a class="menu-link {{ isset($page) && $page == 'recipient' ? 'active-show' : ''}}" href="{{ url('/admin/recipient') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ isset($page) && $page == 'add_on_item' ? 'active-show' : ''}}" href="{{ url('/admin/add-on-item') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion
                    @isset($page)
                        @if($page == 'category' || $page == 'sub_category' || $page == 'feature_tag' || $page == 'key_item_tag' || $page == 'sub_key_item_tag' || $page == 'highlight_tag' || $page == 'vaccine_factory_tag' || $page == 'vaccine_stock_tag' || $page == 'time_slot_tag' || $page == 'price_tag' || $page == 'recommend_tag' || $page == 'dose_tag') hover show @endif
                    @endisset">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link @isset($page) @if($page == 'product') active @endif @endisset" href="{{url('/admin/products')}}">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg" kt-hidden-height="78" style="">
                                <div class="menu-item">
                                    <a class="menu-link @isset($page) @if($page == 'category') active @endif @endisset" href="{{ url('/admin/category') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Categories</span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link @isset($page) @if($page == 'sub_category') active @endif @endisset" href="{{ url('/admin/sub-category') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion
                                @isset($page)
                                    @if($page == 'feature_tag' || $page == 'highlight_tag' || $page == 'vaccine_factory_tag' || $page == 'vaccine_stock_tag' || $page == 'time_slot_tag' || $page == 'price_tag' || $page == 'recommend_tag' || $page == 'dose_tag') hover show @endif
                                @endisset
                            ">
                            <span class="menu-link">
                                <span class="menu-bullet">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg" kt-hidden-height="78">
                                {{-- <div class="menu-item">
                                    <a class="menu-link {{isset($page) && $page == 'dose_tag' ? 'active' : ''}} " href="{{url('admin/dose-tag')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Dose Tags</span>
                                </a>
                            </div> --}}
                            <div class="menu-item">
                                <a class="menu-link {{isset($page) && $page == 'price_tag' ? 'active' : ''}} " href="{{url('admin/price-tag')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Price Tags</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link {{isset($page) && $page == 'time_slot_tag' ? 'active' : ''}} " href="{{url('admin/time-slot-tag')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Time Slot Tags</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link {{isset($page) && $page == 'highlight_tag' ? 'active' : ''}} " href="{{url('admin/highlight-tag')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{isset($page) && $page == 'feature_tag' ? 'active' : ''}} " href="{{url('admin/feature-tag')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Feature Tags</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link {{isset($page) && $page == 'recommend_tag' ? 'active' : ''}} " href="{{url('admin/recommend-tags')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Recommend Tags</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link {{isset($page) && $page == 'vaccine_factory_tag' ? 'active' : ''}} " href="{{url('admin/vaccine-factory-tag')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Vaccine Factory Slot Tags</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link {{isset($page) && $page == 'vaccine_stock_tag' ? 'active' : ''}} " href="{{url('admin/vaccine-stock-tag')}}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Vaccine Stock Tags</span>
                                </a>
                            </div>
                            {{-- <div data-kt-menu-trigger="click" class="menu-item menu-accordion
                                        @isset($page)
                            ...
                            <span class="menu-title">Key Item Tags</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link @isset($page) @if($page == 'sub_key_item_tag') active @endif @endisset" href="{{ url('/admin/sub-key-item-tag') }}">
                                ...
                                <span class="menu-title">Sub Key Item Tags</span>
                            </a>
                        </div>
                    </div>
                </div> --}}
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
                    @isset($page)
                        @if($page == 'main_optional_item' || $page == 'optional_item' || $page == 'check_up_table' || $page == 'check_up_type' || $page == 'check_up_group' || $page == 'check_up_item') hover show @endif
                    @endisset">
    <span class="menu-link">
        <span class="menu-icon">
            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg" kt-hidden-height="78" style="">
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'package') active @endif @endisset" href="{{ url('/admin/packages') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Lists</span>
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div data-kt-menu-trigger="click" class="menu-item menu-accordion
            ...
            <div class="menu-sub menu-sub-accordion menu-active-bg" kt-hidden-height="78" style="">
                <div class="menu-item">
                    <a class="menu-link @isset($page) @if($page == 'check_up_table') active @endif @endisset" href="{{ url('/admin/check-up-table') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">Check Up Table</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link @isset($page) @if($page == 'check_up_type') active @endif @endisset" href="{{ url('/admin/check-up-type') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">Check Up Type</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link @isset($page) @if($page == 'check_up_group') active @endif @endisset" href="{{ url('/admin/check-up-group') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">Check Up Group</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link @isset($page) @if($page == 'check_up_item') active @endif @endisset" href="{{ url('/admin/check-up-item') }}">
                        <span class="menu-bullet">
                            <span class="bullet bullet-dot"></span>
                        </span>
                        <span class="menu-title">Check Up Item</span>
                    </a>
                </div>
            </div>
        </div>
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'supplementary' ? 'active' : ''}}" href="{{ url('/admin/supplementary') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
                    @isset($page)
                        @if($page == 'blog' || $page == 'blog_category') hover show @endif
                    @endisset">
    <span class="menu-link">
        <span class="menu-icon">
            <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'blog') active @endif @endisset" href="{{ url('/admin/blog') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'blog_category') active @endif @endisset" href="{{ url('/admin/blog-category') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
                    @isset($page)
                        @if($page == 'faq' || $page == 'faq_category') hover show @endif
                    @endisset">
    <span class="menu-link">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'faq') active @endif @endisset" href="{{ url('/admin/faq') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'faq_category') active @endif @endisset" href="{{ url('/admin/faq-category') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($p) @if($p == 'page') active @endif @endisset" href="{{ url('/admin/pages') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'about') active @endif @endisset" href="{{ url('/admin/about') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'milestone_year') active @endif @endisset" href="{{ url('/admin/milestone-year') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'choose_mediq' ? 'active-show' : ''}}" href="{{ url('/admin/choose-mediq') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-receipt" viewBox="0 0 16 16">
                    <path d="M1.92.506a.5.5 0 0 1 .434.14L3 1.293l.646-.647a.5.5 0 0 1 .708 0L5 1.293l.646-.647a.5.5 0 0 1 .708 0L7 1.293l.646-.647a.5.5 0 0 1 .708 0L9 1.293l.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .801.13l.5 1A.5.5 0 0 1 15 2v12a.5.5 0 0 1-.053.224l-.5 1a.5.5 0 0 1-.8.13L13 14.707l-.646.647a.5.5 0 0 1-.708 0L11 14.707l-.646.647a.5.5 0 0 1-.708 0L9 14.707l-.646.647a.5.5 0 0 1-.708 0L7 14.707l-.646.647a.5.5 0 0 1-.708 0L5 14.707l-.646.647a.5.5 0 0 1-.708 0L3 14.707l-.646.647a.5.5 0 0 1-.801-.13l-.5-1A.5.5 0 0 1 1 14V2a.5.5 0 0 1 .053-.224l.5-1a.5.5 0 0 1 .367-.27zm.217 1.338L2 2.118v11.764l.137.274.51-.51a.5.5 0 0 1 .707 0l.646.647.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.509.509.137-.274V2.118l-.137-.274-.51.51a.5.5 0 0 1-.707 0L12 1.707l-.646.647a.5.5 0 0 1-.708 0L10 1.707l-.646.647a.5.5 0 0 1-.708 0L8 1.707l-.646.647a.5.5 0 0 1-.708 0L6 1.707l-.646.647a.5.5 0 0 1-.708 0L4 1.707l-.646.647a.5.5 0 0 1-.708 0l-.509-.51z" />
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
                    @isset($page)
                @if($page == 'contact' || $page == 'contact_service') hover show @endif
                @endisset">
    <span class="menu-link">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'contact') active @endif @endisset" href="{{ url('/admin/contact') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'contact_service') active @endif @endisset" href="{{ url('/admin/contact-service') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'quick_link' ? 'active-show' : ''}}" href="{{ url('/admin/quick-link') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-receipt" viewBox="0 0 16 16">
                    <path d="M1.92.506a.5.5 0 0 1 .434.14L3 1.293l.646-.647a.5.5 0 0 1 .708 0L5 1.293l.646-.647a.5.5 0 0 1 .708 0L7 1.293l.646-.647a.5.5 0 0 1 .708 0L9 1.293l.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .801.13l.5 1A.5.5 0 0 1 15 2v12a.5.5 0 0 1-.053.224l-.5 1a.5.5 0 0 1-.8.13L13 14.707l-.646.647a.5.5 0 0 1-.708 0L11 14.707l-.646.647a.5.5 0 0 1-.708 0L9 14.707l-.646.647a.5.5 0 0 1-.708 0L7 14.707l-.646.647a.5.5 0 0 1-.708 0L5 14.707l-.646.647a.5.5 0 0 1-.708 0L3 14.707l-.646.647a.5.5 0 0 1-.801-.13l-.5-1A.5.5 0 0 1 1 14V2a.5.5 0 0 1 .053-.224l.5-1a.5.5 0 0 1 .367-.27zm.217 1.338L2 2.118v11.764l.137.274.51-.51a.5.5 0 0 1 .707 0l.646.647.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.509.509.137-.274V2.118l-.137-.274-.51.51a.5.5 0 0 1-.707 0L12 1.707l-.646.647a.5.5 0 0 1-.708 0L10 1.707l-.646.647a.5.5 0 0 1-.708 0L8 1.707l-.646.647a.5.5 0 0 1-.708 0L6 1.707l-.646.647a.5.5 0 0 1-.708 0L4 1.707l-.646.647a.5.5 0 0 1-.708 0l-.509-.51z" />
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'service_solution' ? 'active-show' : ''}}" href="{{ url('/admin/service-solution') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-receipt" viewBox="0 0 16 16">
                    <path d="M1.92.506a.5.5 0 0 1 .434.14L3 1.293l.646-.647a.5.5 0 0 1 .708 0L5 1.293l.646-.647a.5.5 0 0 1 .708 0L7 1.293l.646-.647a.5.5 0 0 1 .708 0L9 1.293l.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .801.13l.5 1A.5.5 0 0 1 15 2v12a.5.5 0 0 1-.053.224l-.5 1a.5.5 0 0 1-.8.13L13 14.707l-.646.647a.5.5 0 0 1-.708 0L11 14.707l-.646.647a.5.5 0 0 1-.708 0L9 14.707l-.646.647a.5.5 0 0 1-.708 0L7 14.707l-.646.647a.5.5 0 0 1-.708 0L5 14.707l-.646.647a.5.5 0 0 1-.708 0L3 14.707l-.646.647a.5.5 0 0 1-.801-.13l-.5-1A.5.5 0 0 1 1 14V2a.5.5 0 0 1 .053-.224l.5-1a.5.5 0 0 1 .367-.27zm.217 1.338L2 2.118v11.764l.137.274.51-.51a.5.5 0 0 1 .707 0l.646.647.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.509.509.137-.274V2.118l-.137-.274-.51.51a.5.5 0 0 1-.707 0L12 1.707l-.646.647a.5.5 0 0 1-.708 0L10 1.707l-.646.647a.5.5 0 0 1-.708 0L8 1.707l-.646.647a.5.5 0 0 1-.708 0L6 1.707l-.646.647a.5.5 0 0 1-.708 0L4 1.707l-.646.647a.5.5 0 0 1-.708 0l-.509-.51z" />
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'promo_code' ? 'active-show' : ''}}" href="{{ url('/admin/promo-code') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-receipt" viewBox="0 0 16 16">
                    <path d="M1.92.506a.5.5 0 0 1 .434.14L3 1.293l.646-.647a.5.5 0 0 1 .708 0L5 1.293l.646-.647a.5.5 0 0 1 .708 0L7 1.293l.646-.647a.5.5 0 0 1 .708 0L9 1.293l.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .801.13l.5 1A.5.5 0 0 1 15 2v12a.5.5 0 0 1-.053.224l-.5 1a.5.5 0 0 1-.8.13L13 14.707l-.646.647a.5.5 0 0 1-.708 0L11 14.707l-.646.647a.5.5 0 0 1-.708 0L9 14.707l-.646.647a.5.5 0 0 1-.708 0L7 14.707l-.646.647a.5.5 0 0 1-.708 0L5 14.707l-.646.647a.5.5 0 0 1-.708 0L3 14.707l-.646.647a.5.5 0 0 1-.801-.13l-.5-1A.5.5 0 0 1 1 14V2a.5.5 0 0 1 .053-.224l.5-1a.5.5 0 0 1 .367-.27zm.217 1.338L2 2.118v11.764l.137.274.51-.51a.5.5 0 0 1 .707 0l.646.647.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.646.646.646-.646a.5.5 0 0 1 .708 0l.509.509.137-.274V2.118l-.137-.274-.51.51a.5.5 0 0 1-.707 0L12 1.707l-.646.647a.5.5 0 0 1-.708 0L10 1.707l-.646.647a.5.5 0 0 1-.708 0L8 1.707l-.646.647a.5.5 0 0 1-.708 0L6 1.707l-.646.647a.5.5 0 0 1-.708 0L4 1.707l-.646.647a.5.5 0 0 1-.708 0l-.509-.51z" />
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
                    @isset($page)
                        @if($page == 'coupon' || $page == 'cupon_category' ||  $page == 'bundle-coupon') hover show @endif
                    @endisset">
    <span class="menu-link">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'coupon') active @endif @endisset" href="{{ url('/admin/coupon') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Lists</span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'cupon_category') active @endif @endisset" href="{{ url('/admin/cupon-category') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Coupon Category</span>
            </a>
        </div>
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'bundle-coupon') active @endif @endisset" href="{{ url('/admin/bundle-coupon') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Bundle Coupon</span>
            </a>
        </div>
    </div>
</div>
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'onSale') active @endif @endisset" href="{{ url('/admin/on-sale') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Lists</span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'sale_category') active @endif @endisset" href="{{ url('/admin/sale-category') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'promotionCampaign') active @endif @endisset" href="{{ url('/admin/promotion-campaign') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Lists</span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'promotion_category') active @endif @endisset" href="{{ url('/admin/promotion-category') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'QDollarRebate' ? 'active' : ''}}" href="{{ url('/admin/q-dollor-rebate') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'freeGift' ? 'active' : ''}}" href="{{ url('/admin/free-gift') }}">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
                    @isset($page)
                        @if($page == 'carrier' || $page == 'carrier_department') hover show @endif
                    @endisset">
    <span class="menu-link">
        <span class="menu-icon">
            <span class="svg-icon svg-icon-2">
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'carrier') active @endif @endisset" href="{{ url('/admin/carrier') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Carrier</span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'carrier_department') active @endif @endisset" href="{{ url('/admin/carrier-department') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Carrier Department</span>
            </a>
        </div>
    </div>
</div>
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion
    ...
    <div class="menu-sub menu-sub-accordion menu-active-bg">
        <div class="menu-item">
            <a class="menu-link @isset($user_type) @if($user_type == 'user') active @endif @endisset" href="{{ route('users.list','user') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($user_type) @if($user_type == 'merchant') active @endif @endisset" href="{{ route('users.list','merchant') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'roles') active @endif @endisset" href="{{ url('/admin/roles') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
        ...
        <div class="menu-item">
            <a class="menu-link @isset($page) @if($page == 'permissions') active @endif @endisset" href="{{ url('/admin/permissions') }}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
    ...
    <div class="menu-item">
        <a class="menu-link {{ isset($page) && $page == 'activitylog' ? 'active-show' : ''}}" href="{{ url('/admin/activitylogs') }}">
            <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'header' ? 'active-show' : ''}}" href="{{ url('/admin/header') }}">
        <span class="menu-icon">
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'footer' ? 'active-show' : ''}}" href="{{ url('/admin/footer') }}">
        <span class="menu-icon">
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'home' ? 'active-show' : ''}}" href="{{ url('/admin/home') }}">
        <span class="menu-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-border-top" viewBox="0 0 16 16">
                <path d="M0 0v1h16V0H0zm1 2.844v-.938H0v.938h1zm6.5-.938v.938h1v-.938h-1zm7.5 0v.938h1v-.938h-1zM1 4.719V3.78H0v.938h1zm6.5-.938v.938h1V3.78h-1zm7.5 0v.938h1V3.78h-1zM1 6.594v-.938H0v.938h1zm6.5-.938v.938h1v-.938h-1zm7.5 0v.938h1v-.938h-1zM.5 8.5h.469v-.031H1V7.53H.969V7.5H.5v.031H0v.938h.5V8.5zm1.406 0h.938v-1h-.938v1zm1.875 0h.938v-1H3.78v1zm1.875 0h.938v-1h-.938v1zm2.813 0v-.031H8.5V7.53h-.031V7.5H7.53v.031H7.5v.938h.031V8.5h.938zm.937 0h.938v-1h-.938v1zm1.875 0h.938v-1h-.938v1zm1.875 0h.938v-1h-.938v1zm1.875 0h.469v-.031h.5V7.53h-.5V7.5h-.469v.031H15v.938h.031V8.5zM0 9.406v.938h1v-.938H0zm7.5 0v.938h1v-.938h-1zm8.5.938v-.938h-1v.938h1zm-16 .937v.938h1v-.938H0zm7.5 0v.938h1v-.938h-1zm8.5.938v-.938h-1v.938h1zm-16 .937v.938h1v-.938H0zm7.5 0v.938h1v-.938h-1zm8.5.938v-.938h-1v.938h1zM0 16h.969v-.5H1v-.469H.969V15H.5v.031H0V16zm1.906 0h.938v-1h-.938v1zm1.875 0h.938v-1H3.78v1zm1.875 0h.938v-1h-.938v1zm1.875-.5v.5h.938v-.5H8.5v-.469h-.031V15H7.53v.031H7.5v.469h.031zm1.875.5h.938v-1h-.938v1zm1.875 0h.938v-1h-.938v1zm1.875 0h.938v-1h-.938v1zm1.875-.5v.5H16v-.969h-.5V15h-.469v.031H15v.469h.031z" />
            </svg>
...
<div class="menu-item">
    <a class="menu-link {{ isset($page) && $page == 'slider' ? 'active-show' : ''}}" href="{{ url('/admin/sliders') }}">
        <span class="menu-icon">
