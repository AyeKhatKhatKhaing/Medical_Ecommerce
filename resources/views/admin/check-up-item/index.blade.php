...
@section('title', 'Check Up Item')
@section('breadcrumb', 'Check Up Item')
@section('breadcrumb-info', 'Check Up Item Lists')
@push('style')
@endpush
@section('content')
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/check-up-item/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="checkUpItemTable">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                <th>ID</th>
                                <th>Item Name</th>
                                <th>Equivalent No: of Items</th>
                                <th>Gender</th>
                                <th>Status</th>
                                <th>Last Updated</th>
                        ...
                        <tbody class="fw-bold text-gray-600" id="check-up-item">
...
<script>
    $(document).ready(function() {
        let me = this;
        me.table = $("#checkUpItemTable").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/check-up-item/getData",
                type: 'POST',
                headers: {
            ...
            columns: [{
                ...
                {
                    data: 'equivalent_number',
                    name: 'equivalent_number'
                },
                {
                    data: 'gender',
                    name: 'gender'
