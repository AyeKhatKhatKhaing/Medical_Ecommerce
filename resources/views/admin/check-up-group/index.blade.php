...
@section('title', 'Check Up Group')
@section('breadcrumb', 'Check Up Group')
@section('breadcrumb-info', 'Check Up Group Lists')
@push('style')
@endpush
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <a href="{{ url('/admin/check-up-group/create') }}"><button type="button" class="btn btn-primary btn-sm"><i class="bi bi-plus" aria-hidden="true"></i>Add New</button></a>
                        </div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <table class="table align-middle table-row-dashed fs-6 gy-5 requestDelete" id="checkUpGroupTable">
                        <thead>
                        ...
                        <tbody class="fw-bold text-gray-600" id="check-up-group">
                        </tbody>
                    </table>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        let me = this;
        me.table = $("#checkUpGroupTable").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            ajax: {
                url: "/admin/check-up-group/getData",
                type: 'POST',
                headers: {
                ...
                data: function(f) {
                    ...
                    f.checkupitem = $('select[name=check_up_item]').val();
                    f.search = $('#search').val();
                }
            },
            columns: [{
        ...
        $('#check_up_item').on('change', function(e) {
            me.table.draw();
            e.preventDefault();
        });
    });
