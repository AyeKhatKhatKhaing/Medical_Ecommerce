...
@section('title', 'Edit Check Up Group')
@section('breadcrumb', 'Check Up Group')
@section('breadcrumb-info', 'Edit Check Up Group')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                @endif
                {!! Form::model($checkupgroup, [
                    'method' => 'PATCH',
                    'url' => ['/admin/check-up-group', $checkupgroup->id],
                    'class' => 'form-horizontal'
                    ]) !!}
                    
                    @include ('admin.check-up-group.form', ['formMode' => 'edit'])
