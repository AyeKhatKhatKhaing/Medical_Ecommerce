            ...
            <table bgcolor="white" align="center" valign="middle" border="0"
                        ...
                        <table class="no-padding-table" bgcolor="white" align="left" valign="middle" border="0" style="border-radius: 12px;">
                            <tr>
                                <td style="padding:0 15px;padding-top: 18px;">
                                    <p class="custom-text" style="font-size: 16px;font-weight:400;color: #363848;"><b>@lang('labels.email.order_info')</b>
                                    </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="no-padding-table" bgcolor="white" align="left" valign="middle" border="0">
                            <tr>
                                <td style="padding:0 15px;">
                                    <p class="custom-text" style="font-size: 16px; font-weight: 400; color: #363848;"><span style="min-width: 150px;display: inline-block;">@lang('labels.email.order_no')</span> <b>{{$data['order']['invoice_no']}}</b>
                                    </p>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td style="padding:0 15px;">
                                    <p class="custom-text"
                                        ...
                                        <span style="min-width: 150px;display: inline-block;">@lang('labels.email.order_date')</span> <b>{{date('d F Y', strtotime($data['order']['created_at']))}} </b>
                                    </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="no-padding-table" bgcolor="white" align="left" valign="middle" border="0">
                            <tr>
                                <td style="padding:0 15px;">
                                    <p class="custom-text"
                                        style="font-size: 16px; margin: 0px; font-weight: 400; color: #363848;">
                                        <span style="min-width: 150px;display: inline-block;">@lang('labels.email.payment_status')</span> <b>{{$data['order']['payment_type'] == 'other_pay' ? 'Processing' : __('labels.email.paid')}}</b>
                                    </p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="no-padding-table" bgcolor="white" align="left" valign="middle" border="0">
                            <tr>
                                <td style="padding:0 15px;">
                                    <p class="custom-text"
                                        style="font-size: 16px; margin: 0px; font-weight: 400; color: #363848;">
                                        <span style="min-width: 150px;display: inline-block;">@lang('labels.email.payment_method')</span> <b>{{$data['customerInfo']['card_type']}}</b>
                                    </p>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td style="padding:0 15px;">
                                    <p class="custom-text"
                                        ...
                                        <span style="min-width: 150px;display: inline-block;">@lang('labels.email.coupon')</span> <b>{{$data['order']->coupon->name_en}}</b>
                                        @endif
                                        
                                        @if(isset($data['order']->promoCode))
                                        <span style="min-width: 150px;display: inline-block;">@lang('labels.email.promo_code')</span> <b>{{$data['order']->promoCode->code}}</b>
                                        @endif
                                    </p>
                                    </p>
                                </td>
                            ...
                            <tr>
                                <td style="padding:0 15px;">
                                    <p class="custom-text" style="font-size: 16px; margin: 0px; font-weight: 400; color: #363848;">
                                       @lang('labels.email.name_on_recipient') <b>{{$data['customerInfo']['name']}}</b>
                                    </p>                                
                                </td>
                            </tr>
                        </table>
                    ...
                    <td>
                        <table class="no-padding-table" bgcolor="white" align="left" valign="middle" border="0" style="width: 100%;">
                            <tr>
                                <td style="padding:0 15px;">
                                    <p class="custom-text" style="font-size: 16px; margin: 0px; font-weight: 400; color: #363848;">
                                        @lang('labels.email.mailing_address') <b>{{$data['customerInfo']['postal_address']}}</b>
                                    </p>                                
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td style="padding:0 0 0 15px;text-align: center;">
                                    <img width="80" height="80" src="{{asset($item->product->featured_img)}}"
                                        alt="product logo" style="width: 80px;height:80px;object-fit: contain" />
                                </td>
                ...
                <tr>
                    <td style="padding: 0px 15px;">
                        <hr style="background-color: #E4E4E4;margin: 20px 0; border: 0.1px solid rgb(228,228,228);" />
                    </td>
                </tr>
                @if( isset($data['order']->coupon_id) || isset($data['order']->promo_code_id) )
                <tr>
