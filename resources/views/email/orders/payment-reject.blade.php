    ...
    <div style="max-width: 640px;margin: 0 auto;">
        ...
        <div style="padding: 0 15px 26px 15px;background: linear-gradient(to bottom, #f3f7f7 21%, #2fa9b5 1%);">
                <table bgcolor="white" align="center" valign="middle" border="0" width="100%"
                    ...
                    <tr>
                        <td>
                            <table class="no-padding-table" bgcolor="white" align="left" valign="middle" border="0" style="border-radius: 12px; background-color:white !important;">
                                <tr>
                                ...
                                <tr>
                                    <td style="padding:0 15px;">
                                        <p class="custom-text"
                                            ...
                                            @if($data['default_lang']=='en')
                                            The payment for your order <b>(Order Number #{{$data['invoice_no']}})</b> still needs to be completed. You can use the button below to view and pay online.
                                            @elseif($data['default_lang']=='zh-hk')
                                            您訂單付款 <b>(訂單編號 #{{$data['invoice_no']}})</b> 未完成。您可以使用以下按鈕查看及進行網上付款。        
                                            @else
                                            您订单付款 <b>(订单编号 #{{$data['invoice_no']}})</b> 未完成。您可以使用以下按鈕查看及進行網上付款。    
                                            @endif
                            ...
                            <tr>
                              <td style="padding: 0 15px">
                                <p class="custom-text" style="
                                    ...
                                    ">
                                    @if($data['default_lang']=='en')
                                    Order Number: <b>{{$data['invoice_no']}}</b><br/><br/>
                                    @elseif($data['default_lang']=='zh-hk')
                                    訂單編號: <b>{{$data['invoice_no']}}</b><br/><br/>      
                                    @else
                                    订单编号: <b>{{$data['invoice_no']}}</b><br/><br/>             
                                    @endif
                                </p>
                              </td>
                            </tr>
                                ...
                                <tr>
                                    <td style="padding:0 15px;">
                                        <p class="custom-text"
                                            style="font-size: 16px; margin: 0px; font-weight: 400; color: #333;">
                                            @if($data['default_lang']=='en')
                                            Your order payment is rejected.<br/><br/>
                                            @elseif($data['default_lang']=='zh-hk')
                                            您的訂單收款被拒絕。<br/><br/>      
                                            @else
                                            您的订单收款被拒绝。<br/><br/>             
                            ...
                            <table class="no-padding-table" bgcolor="white" align="left" valign="middle" border="0">
                                <tr>
                                    <td style="padding:0 15px;">
                                        ...
                                        @endphp
                                        <a href="{{$bookingUrl}}" style="font-size: 16px;font-weight: bold;color: #fff;display: inline-block;
                                        border-radius: 50px;
