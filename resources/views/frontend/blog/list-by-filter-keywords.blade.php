                ...
                <div class="blog-banner-container-item relative h-[190px] w-full flex flex-col items-center justify-center"
                    ...
                    <div class="blog-floating-container w-full h-full">
                        <h1 class="me-body32 text-whitez helvetica-normal font-bold text-center blog-main-title">
                            <span class="blog-main-title-main">@lang('labels.blog.search') :</span>
                            <span class="result-text text-blueMediq">{{$filterKeywords}}</span>
                        </h1>
                        <div class="blog-menu-search mt-[40px]">
                            <div class="blog-header-search relative hidden">
                                <input type="text"
                                    ...
                                    placeholder="@lang('labels.blog.what_article_looking_for')" id="keyword" value="{{$filterKeywords}}">
        ...
        <div id="feature" class="bb-item">
            <div component-name="me-blog-other-card"
                ...
                <div component-name="me-subtitle-and-label-tag" class="slt-container">
                    <h3 class="helvetica-normal me-body32 text-darkgray font-bold">@lang("labels.blog.related_keyword")</h3>
                    <ul class="mt-[20px] mslt-ul flex flex-wrap items-center justify-start">
                        <li class="me-body18 helvetica-normal text-blueMediq bg-paleblue border border-blueMediq mr-[20px] mslt-item mb-[20px] rounded-[50px] px-[20px] py-[8px] leading-[21.6px] cursor-pointer hover:text-whitez hover:bg-blueMediq searched">
                            {{$filterKeywords}}
                        </li>
                        @if($related_keywords !== [])
                            @foreach ($related_keywords as $keyword)
                            <li class="me-body18 helvetica-normal text-blueMediq bg-paleblue border border-blueMediq mr-[20px] mslt-item mb-[20px] rounded-[50px] px-[20px] py-[8px] leading-[21.6px] cursor-pointer hover:text-whitez hover:bg-blueMediq">
                                {{ $keyword }}
                            </li>
                            @endforeach
                        @endif
                ...
                <div class="flex flex-wrap md:flex-nowrap justify-between mt-[12px]">
                    ...
                    <div class="blog-right md:pl-[25px] xl:pl-[45px] basis-full md:basis-2/5">
                        @php
                            $popularArticles = App\Models\Blog::whereIsPublished(true)
                                                                ->whereIsPopular(true)
                                                                ->limit(5)
                                                                ->get();
                        @endphp
