...
@section('content')
    ...
    <div class="mt-[30px] lg:mt-[60px] faq-content-container">
        <div component-name="faq-header-section" class="faq-header-section-container">
            <div class="faq-header-section-content flex md:flex-nowrap flex-wrap-reverse">
                    ...
                    <div class="flex flex-wrap 2xl:w-[410px] lg:w-[320px] md:w-[230px] w-full">
                        <div class="flex w-full">
                            <div class="border-1 border-meA3 lg:px-5 px-2 py-2 rounded-tl-lg rounded-bl-lg w-full">
                                ...
                                <input type="hidden" value="{{ $subcategory->category_id }}" id="category_id">
                            </div>
                ...
                <div class="flex flex-wrap items-center md:my-0 my-1">
                    ...
                    <a href="{{ route('faq.category', $subcategory->category_id) }}">
                    <p class="font-normal me-body16 text-darkgray mr-[10px] faq-header-link">
        ...
        <div class="flex md:flex-row flex-col">
            ...
            <div component-name="me-faq-category-content"
                ...
                <div>
                    <div class="mt-8">
                        <h1 class="font-bold me-body29 text-darkgray">{{ langbind($subcategory, 'name') }}</h1>
                                                    ...
                                                    @if (count($subcategory->faqs) > 0)
                                                        @foreach ($subcategory->faqs as $key => $faq)
                                                            <a class="mr-3 block border-b border-b-mee4 last:border-0" href="{{ route('faq.detail', $faq->id) }}">
                                                                ...
                                                                <li id="search_result"
                                                                    class="@if ($key > 2) hidden @endif hover:bg-far font-normal me-body20 text-darkgray lg:px-5 px-3 py-4 w-fll flex items-center justify-start">

                                                                    <span class="" style="background-color:red;">Payment </span> Method
                                                                    <div class="ml-auto">
