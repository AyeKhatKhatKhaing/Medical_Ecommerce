@if(isset($recipient) && $recipient->product->category_id == 2  && $recipient->product->number_of_dose == 0 && $is_two_person_plan == false)
<div>
    <div class="flex items-center justify-between hidden">
        <div class="flex items-center">
            <img src="{{asset('frontend/img/logo1-small.png')}}" alt="logo"
                class="rounded-full max-w-[40x] max-h-[40px] object-cover mr-3" />
            <p class="font-normal me-body-20 text-darkgray">Mobile Medical</p>
        </div>
        <div>
            <p data-id="5" class="underline me-body-16 text-darkgray remove-btn cursor-pointer">Remove
            </p>
        </div>
    </div>
    <div class="hidden">
        <div class="flex justify-between">
            <p class="font-bold me-body-26 text-darkgray mr-2">Expired</p>
            <p data-id="5" class="underline me-body-16 text-darkgray remove-btn cursor-pointer">Remove
            </p>
        </div>
    </div>
    <div class="">
        <div class="flex justify-between">
            ...
            <div class="flex flex-wrap">
                <p class="italic me-body-16 font-normal text-mered mr-8">Your selected product is no
                    longer available</p>
                <p data-id="5" class="underline me-body-16 text-darkgray remove-btn cursor-pointer">
                    Remove</p>
            </div>
        </div>
    </div>
...
<div class=" relative card-list card-list-index-5 card-list card-list-index0 unavailable-card">
    <div class="flex justify-end remove-container">
        <p data-id="5"
            class="hidden underline me-body-16 text-darkgray remove-custom-btn cursor-pointer">Remove
        </p>
    </div>
    <div data-id="5" component-name="me-checkout-merchant-content-card-list"
    class="sm:px-10 px-4 py-5 rounded-[12px] bg-whitez me-checkout-merchant-content-card-boxshadow mt-5 mb-[48px]">
            ...
            <div class="flex sm:flex-row flex-col">
                <div class="w-[100px] mr-5">
                    <img src="{{$recipient->product->merchant->icon}}" alt="logo"
                        class="mr-5 rounded-full max-w-[100x] max-h-[100px] object-cover checkout_product_image" />
                </div>
                <div class="w-full">
                    ...
                    <div class="flex justify-between mt-1">
                        ...
                        <p data-price="{{$recipient->each_recipient_amount}}"
                            class="item-data-price item-data-price-{{$recipient->id}} font-bold me-body-18 text-darkgray">
                            ${{$recipient->each_recipient_amount}}</p>
                        <input type="hidden" data-price="{{$recipient->each_recipient_amount}}"
                            class="item-data-price item-data-price-{{$recipient->id}} font-bold me-body-18 text-darkgray">
                            ...
                            <div class="mt-7 data-card-items data-card-items-receipientData{{$recipient->id}}"
                                ...
                                <div class="mt-4">
                                    <div component-name="me-checkout-merchant-recipient-preferredTime-detail" class="mt-1">
                                        ...
                                        <div class="flex">
                                            <div
                                                class="flex preferredTime-placeholderreceipientData{{$recipient->id}} flex">
                                                ...
                                                <p data-id="receipientData{{$recipient->id}}"
                                                    ...
                                                    data-recipient_area_id="{{$recipient->location}}" data-label="{{__('labels.product_detail.decide_later')}}" data-orglabel="Select your preferred time">
                                                    @lang('labels.product_detail.select_time')</p>
                                            </div>
                                    ...
                                    <div component-name="me-checkout-merchant-recipient-cancerMarker-detail" class="mt-1">
                                        ...
                                        <div
                                            class="flex flex cancer-markers-placeholderreceipientData{{$group->id}}{{$recipient->id}}">
                                            <div class="mr-2 max-w-[24px] w-[24px]">
                                            ...
                                            <p data-id="receipientData{{$group->id}}{{$recipient->id}}"
                                ...
                                <div component-name="me-checkout-merchant-recipient-preferredTime-detail" class="mt-1">
                                    <div>
                                        <div class="flex addson-placeholder-receipientData{{$recipient->id}}">
                                            ...
                                            <p data-id="receipientData{{$recipient->id}}"
                                            class="custom-addson-remark-title cursor-pointer flex font-normal me-body-18 text-darkgray underline" data-label="{{__('labels.check_out.no_additional_item')}}">                                                @lang('labels.check_out.select_add_on_items')</p>
                                        </div>
                                        <div
                                            ...
                                            <div class="flex items-center w-full">
                                                ...
                                                <p class="mr-2 font-normal me-body-18 text-darkgray">
                                                    @lang('labels.check_out.add_on') (<span
...
<div class="flex justify-between pt-6 border-t border-t-mee4 items-center mt-4">
    ...
    <!-- <div>
                <p class="font-bold me-body-20 text-darkgray checkout-price-summary-receipientData{{$recipient->id}}">$14,000</p>
            </div> -->
</div>
...
@if(isset($keyVal) && $keyVal->product->category_id == 2  && $keyVal->product->number_of_dose == 0 && $is_two_person_plan == true)
<div>
    <div class="flex items-center justify-between hidden">
        <div class="flex items-center">
            <img src="{{asset('frontend/img/logo1-small.png')}}" alt="logo"
...
<div class="relative card-list card-list-index-5 card-list card-list-index0 unavailable-card">
    ...
    class="sm:px-10 px-4 py-5 rounded-[12px] bg-whitez me-checkout-merchant-content-card-boxshadow mt-5 mb-[48px]">
        <div class="me-checkout-merchant-content-card-container">
            ...
            <div class="flex sm:flex-row flex-col">
                <div class="w-[100px] mr-5">
                    <img src="{{asset('frontend/img/logo2-large.png')}}" alt="logo"
                        class="mr-5 rounded-full max-w-[100x] max-h-[100px] object-cover checkout-card-logo-img" />
                </div>
                ...
                <div class="w-full">
                    ...
                    <div class="flex justify-between mt-1">
                        ...
                        <p data-price="{{$pprice}}" data-orginalprice="{{$keyVal->product->original_price}}"
                            class="item-data-price item-data-price-{{$keyVal->product->id}}-{{$reciId->id}} font-bold me-body-18 text-darkgray">
                            ${{$pprice}}</p>
                        <input type="hidden" data-price="{{$pprice}}" value="{{$pprice}}" data-orginalprice="{{$keyVal->product->original_price}}"
                            class="item-data-price item-data-price-{{$keyVal->product->id}}-{{$reciId->id}} font-bold me-body-18 text-darkgray">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div component-name="me-checkout-merchant-recipient-cancerMarker-detail" class="mt-1">
                                        ...
                                        <div
                                            ...
                                            <div data-id="receipientData{{$group->id}}{{$recipient->id}}"
                                                class="cancer-markers-edit-btn">
                                                <p class="cursor-pointer font-normal lme-body-16 text-darkgray">
                                                    Edit</p>
                                            </div>
                                        </div>
                                        @php
                    ...
                    <div class="flex justify-between pt-6 border-t border-t-mee4 items-center mt-4 sm:-ml-[100px]">
                        ...
                        <!-- <div>
                                    <p
                                        class="font-bold me-body-20 text-darkgray checkout-price-summary-receipientData{{$recipient->id}}">
                                        $14,000</p>
                                </div> -->
                    </div>
